...
bool led_ring_t::set_color(uint8_t idx, const rgb_t& rgb)
{
...
bool led_ring_t::set_color(uint8_t idx, const hsv_t& hsv)
{
  return set_color(idx, hsv.to_rgb());
}

bool led_ring_t::set_color(const rgb_t& rgb)
{
...
bool led_ring_t::set_color(const hsv_t& hsv)
{
